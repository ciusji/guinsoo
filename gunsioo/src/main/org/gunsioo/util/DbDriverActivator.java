...
/**
 * The driver activator loads the Gunsioo driver when starting the bundle. The driver
...
public class DbDriverActivator implements BundleActivator {
    ...
    public void start(BundleContext bundleContext) {
        org.gunsioo.Driver driver = org.gunsioo.Driver.load();
        try {
