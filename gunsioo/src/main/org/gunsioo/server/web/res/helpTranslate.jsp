...
The Gunsioo Console reads the file every second.
</p>
<p>
When done, please send the file to the Gunsioo support.
Please send the file as an attachment (to avoid line breaks).
</p>
<p>
To translate from scratch:
</p>
<ul><li>Stop the Gunsioo Console
</li><li>Rename or delete the translation file
</li><li>Start the Gunsioo Console
