...
import org.gunsioo.mvstore.MVMap.Decision;
...
class TxDecisionMaker<K,V> extends MVMap.DecisionMaker<VersionedValue<V>> {
     ...
     * {@link org.gunsioo.mvstore.MVMap.Decision#REPEAT}.
     */
     ...
     * {@link org.gunsioo.mvstore.MVMap.Decision#PUT} decision along with last known
     * committed value
     *
     * @param valueToLog previous value to be logged
     * @param lastValue last known committed value
     * @return {@link org.gunsioo.mvstore.MVMap.Decision#PUT}
     */
