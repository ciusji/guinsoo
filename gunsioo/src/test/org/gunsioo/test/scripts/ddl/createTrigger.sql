...
CREATE TRIGGER T1 BEFORE INSERT, UPDATE ON TEST FOR EACH ROW CALL 'org.gunsioo.test.scripts.Trigger1';
> ok
...
CREATE TRIGGER T1 BEFORE INSERT ON TEST FOR EACH ROW CALL 'org.gunsioo.test.scripts.Trigger1';
> ok
...
CREATE TRIGGER T1 BEFORE INSERT ON TEST FOR EACH STATEMENT CALL 'org.gunsioo.test.scripts.Trigger1';
> ok
...
'org.gunsioo.api.Trigger create() {
    return new org.gunsioo.api.Trigger() {
