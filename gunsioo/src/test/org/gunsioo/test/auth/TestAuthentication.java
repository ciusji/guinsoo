...
import org.gunsioo.engine.Engine;
import org.gunsioo.engine.Role;
import org.gunsioo.engine.SessionLocal;
import org.gunsioo.engine.User;
import org.gunsioo.jdbcx.JdbcConnectionPool;
import org.gunsioo.security.auth.DefaultAuthenticator;
import org.gunsioo.security.auth.H2AuthConfig;
import org.gunsioo.security.auth.H2AuthConfigXml;
import org.gunsioo.security.auth.impl.AssignRealmNameRole;
import org.gunsioo.security.auth.impl.JaasCredentialsValidator;
import org.gunsioo.security.auth.impl.StaticRolesMapper;
import org.gunsioo.security.auth.impl.StaticUserCredentialsValidator;
...
public class TestAuthentication extends TestBase {
    ...
    private String getDatabaseURL() {
        return "jdbc:gunsioo:mem:" + getClass().getSimpleName();
    }
