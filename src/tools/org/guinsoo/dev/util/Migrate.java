...
/**
 * Migrate a Guinsoo database version 1.1.x (page store not enabled) to 1.2.x (page
 * store format). This will download the Guinsoo jar file version 1.2.127 from
 ...
 * created a new database (using the Guinsoo jar file in the class path) using the
 * Script tool, and then delete the backup.sql file. Most utility methods are
 * copied from guinsoo/src/tools/org/guinsoo/build/BuildBase.java.
 */
public class Migrate {

    private static final String USER = "sa";
    private static final String PASSWORD  = "sa";
    private static final File OLD_H2_FILE = new File("./guinsoo-1.2.127.jar");
    private static final String DOWNLOAD_URL =
            "https://repo1.maven.org/maven2/com/guinsoodatabase/guinsoo/1.2.127/guinsoo-1.2.127.jar";
