...
public class Test extends TestBase {
    ...
    public void test() throws IOException {
        ...
        parser.parse("src/tools/org/guinsoo", "java.lang.Object");
        parser.parse("src/tools/org/guinsoo", "java.lang.String");
        parser.parse("src/tools/org/guinsoo", "java.lang.Math");
        parser.parse("src/tools/org/guinsoo", "java.lang.Integer");
        parser.parse("src/tools/org/guinsoo", "java.lang.Long");
        parser.parse("src/tools/org/guinsoo", "java.lang.StringBuilder");
        parser.parse("src/tools/org/guinsoo", "java.io.PrintStream");
        parser.parse("src/tools/org/guinsoo", "java.lang.System");
        parser.parse("src/tools/org/guinsoo", "java.util.Arrays");
        parser.parse("src/tools", "org.guinsoo.java.TestApp");
