 ...
 */
package org.guinsoo.build.doclet;
...
public class ResourceDoclet {
    ...
    private String destFile = System.getProperty("guinsoo.javadocResourceFile",
            "src/main/org/guinsoo/res/javadoc.properties");
    ...
    private static boolean isResource(Doc doc) {
        for (Tag t : doc.tags()) {
            if (t.kind().equals("@guinsoo.resource")) {
                return true;
            }
        }
        return false;
