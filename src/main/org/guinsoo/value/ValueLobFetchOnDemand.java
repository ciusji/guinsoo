/*
 * Copyright 2004-2021 Guinsoo Group. Multiple-Licensed under the MPL 2.0, and the
...
import org.guinsoo.store.LobStorageRemoteInputStream;

/**
 * A implementation of the BLOB and CLOB data types used on the client side of a
 * remote Guinsoo connection. Fetches the underlying on data from the server.
 */
