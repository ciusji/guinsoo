...
import org.guinsoo.jdbc.JdbcResultSet;
import org.guinsoo.util.IntervalUtils;
import org.guinsoo.util.JSR310Utils;
...
public final class ValueToObjectConverter2 extends TraceObject {
    ...
    public static TypeInfo classToType(Class<?> clazz) {
        ...
        } else if (ValueToObjectConverter.GEOMETRY_CLASS != null && ValueToObjectConverter.GEOMETRY_CLASS.isAssignableFrom(clazz)) {
