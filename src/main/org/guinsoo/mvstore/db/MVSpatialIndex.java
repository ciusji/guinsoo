...
import org.guinsoo.mvstore.tx.VersionedValueType;
...
public class MVSpatialIndex extends MVIndex<Spatial, Value> implements SpatialIndex {
    ...
    public void add(SessionLocal session, Row row) {
        ...
        if (indexType.isUnique()) {
            ...
            MVRTreeMap.RTreeCursor<VersionedValue<Value>> cursor = spatialMap.findContainedKeys(key);
