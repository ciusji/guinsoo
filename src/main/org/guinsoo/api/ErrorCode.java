...
public class ErrorCode {
     ...
     * path, such as "jdbc:guinsoo:test" (in which case the database file would be
     ...
     * are used. Instead, use "jdbc:guinsoo:~/name" (relative to the current user
     * home directory), use an absolute path, set the base directory (baseDir),
     * use "jdbc:guinsoo:./name" (explicit relative path), or set the system property
     * "guinsoo.implicitRelativePath" to "true" (to prevent this check). For Windows,
     ...
     * <pre>
     * Connection conn;
     * conn = DriverManager.getConnection(&quot;jdbc:guinsoo:&tilde;/test&quot;);
     * conn = null;
     ...
     * <ul><li>In embedded mode (URL of the form jdbc:guinsoo:~/test) if all
     * connections are opened within the same process and class loader.
     * </li><li>In server and cluster mode (URL of the form
     * jdbc:guinsoo:tcp://localhost/test) using remote connections.
     * </li></ul>
     ...
     * Recovery tool (org.guinsoo.tools.Recover).
     */
     ...
     *      CALL "org.guinsoo.samples.TriggerSample$MyTrigger";
     * CREATE TRIGGER TRIGGER_A AFTER INSERT ON TEST
     *      CALL "org.guinsoo.samples.TriggerSample$MyTrigger";
     * </pre>
     */
     ...
     * Example of wrong usage:
     * <pre>
     * String url = &quot;jdbc:guinsoo:&tilde;/test;CIPHER=AES&quot;;
    ...
    */
     ...
     * Example:
     * <pre>
     * jdbc:guinsoo:~/test;FILE_LOCK=LDAP
     * </pre>
     */
     ...
     * Example:
     * <pre>
     * jdbc:guinsoo:~/test;LOCK_TIMEOUT=0;LOCK_TIMEOUT=1
     * </pre>
     */
     ...
     * possible causes are: the server is not an Guinsoo server, or the network
     ...
     * Example:
     * <pre>
     * jdbc:guinsoo:~/test;ACCESS_MODE_DATA=R
     * CREATE TABLE TEST(ID INT);
     * </pre>
     */
     ...
     * <pre>
     * jdbc:guinsoo:&tilde;/test;DATABASE_EVENT_LISTENER='java.lang.String'
     * </pre>
     */
     ...
     * Example:
     * <pre>
     * jdbc:guinsoo:~/test;UNKNOWN=TRUE
     * </pre>
     */
     ...
     * <pre>
     * java org.guinsoo.tools.Server -tcp -tcpAllowOthers
     * </pre>
     ...
     * class BigDecimal, and the system property guinsoo.allowBigDecimalExtensions is
     ...
     * system property guinsoo.allowedClasses.
     */
     ...
     * Example of wrong usage:
     * <pre>
     * DriverManager.getConnection("jdbc:guinsoo:~/t");
     * DriverManager.getConnection("jdbc:guinsoo:~/test/");
     * </pre>
     * Correct:
     * <pre>
     * DriverManager.getConnection("jdbc:guinsoo:~/te");
     * DriverManager.getConnection("jdbc:guinsoo:~/test/te");
     * </pre>
     */
     ...
     * <pre>
     * jdbc:guinsoo:./database_that_does_not_exist
     * </pre>
     */
     ...
     *
     * @see SysProperties#FORCE_AUTOCOMMIT_OFF_ON_COMMIT
     */
