...
public class CipherFactory {
    ...
    /**
     * The default password to use for the .guinsoo.keystore file
     */
...
/**
     ...
     * If guinsoo.enableAnonymousTLS is true, an attempt is made to modify
    ...
    public static KeyStore getKeyStore(String password) throws IOException {
        try {
            ...
            store.setKeyEntry("guinsoo", privateKey, password.toCharArray(), certs);
            // --- generated code end ---
            return store;
        } catch (Exception e) {
            throw DataUtils.convertToIOException(e);
