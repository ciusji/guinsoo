...
import org.guinsoo.jdbcx.JdbcDataSource;
import org.osgi.framework.BundleContext;
import org.osgi.service.jdbc.DataSourceFactory;

/**
 * This class implements the OSGi DataSourceFactory interface for the Guinsoo JDBC
 ...
 * property will be treated as a Guinsoo specific option. If the {@link #JDBC_URL}
...
public class OsgiDataSourceFactory implements DataSourceFactory {
    ...
    public ConnectionPoolDataSource createConnectionPoolDataSource(
        ...
        // The integrated connection pool is Guinsoo is not configurable
        rejectPoolingOptions(propertiesCopy);
    ...
    /**
     * Returns a driver. The Guinsoo driver does not support any properties.
     *
    ...
    /**
     * Applies common OSGi properties to a Guinsoo data source. Non standard
     * properties will be applied as Guinsoo options.
     *
    ...
    /**
     * Register the Guinsoo JDBC driver service.
     *
