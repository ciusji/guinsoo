...
public class IntervalUtils {
    ...
    public static ValueInterval parseInterval(IntervalQualifier qualifier, boolean negative, String s) {
        ...
        case DAY_TO_SECOND: {
            ...
            if (space < 0) {
                ...
                int colon = s.indexOf(':', space + 1);
                if (colon < 0) {
                    remaining = parseIntervalRemaining(s, space + 1, s.length(), 23) * DateTimeUtils.NANOS_PER_HOUR;
                } else {
                    int colon2 = s.indexOf(':', colon + 1);
                    if (colon2 < 0) {
                        remaining = parseIntervalRemaining(s, space + 1, colon, 23) * DateTimeUtils.NANOS_PER_HOUR
                                + parseIntervalRemaining(s, colon + 1, s.length(), 59) * DateTimeUtils.NANOS_PER_MINUTE;
                    } else {
                        remaining = parseIntervalRemaining(s, space + 1, colon, 23) * DateTimeUtils.NANOS_PER_HOUR
                                + parseIntervalRemaining(s, colon + 1, colon2, 59) * DateTimeUtils.NANOS_PER_MINUTE
        ...
        case HOUR_TO_SECOND: {
            ...
            if (colon < 0) {
                ...
                int colon2 = s.indexOf(':', colon + 1);
                if (colon2 < 0) {
                    remaining = parseIntervalRemaining(s, colon + 1, s.length(), 59) * DateTimeUtils.NANOS_PER_MINUTE;
                } else {
                    remaining = parseIntervalRemaining(s, colon + 1, colon2, 59) * DateTimeUtils.NANOS_PER_MINUTE
                            + parseIntervalRemainingSeconds(s, colon2 + 1);
                }
            }
            break;
    ...
    public static StringBuilder appendInterval(StringBuilder buff, IntervalQualifier qualifier, boolean negative,
        ...
        case DAY_TO_SECOND: {
            long nanos = remaining % DateTimeUtils.NANOS_PER_MINUTE;
            int r = (int) (remaining / DateTimeUtils.NANOS_PER_MINUTE);
            buff.append(leading).append(' ');
            StringUtils.appendTwoDigits(buff, r / 60).append(':');
            StringUtils.appendTwoDigits(buff, r % 60).append(':');
            StringUtils.appendTwoDigits(buff, (int) (nanos / DateTimeUtils.NANOS_PER_SECOND));
            DateTimeUtils.appendNanos(buff, (int) (nanos % DateTimeUtils.NANOS_PER_SECOND));
            break;
        }
        case HOUR_TO_MINUTE:
            buff.append(leading).append(':');
        ...
        case HOUR_TO_SECOND: {
            buff.append(leading).append(':');
            StringUtils.appendTwoDigits(buff, (int) (remaining / DateTimeUtils.NANOS_PER_MINUTE)).append(':');
            long s =  remaining % DateTimeUtils.NANOS_PER_MINUTE;
            StringUtils.appendTwoDigits(buff, (int) (s / DateTimeUtils.NANOS_PER_SECOND));
            DateTimeUtils.appendNanos(buff, (int) (s % DateTimeUtils.NANOS_PER_SECOND));
            break;
        }
        case MINUTE_TO_SECOND:
            buff.append(leading).append(':');
            StringUtils.appendTwoDigits(buff, (int) (remaining / DateTimeUtils.NANOS_PER_SECOND));
            DateTimeUtils.appendNanos(buff, (int) (remaining % DateTimeUtils.NANOS_PER_SECOND));
            break;
        }
    ...
    public static boolean validateInterval(IntervalQualifier qualifier, boolean negative, long leading,
        ...
        case MINUTE:
            ...
            break;
        case SECOND:
            bound = DateTimeUtils.NANOS_PER_SECOND;
            break;
        case YEAR_TO_MONTH:
            bound = 12;
            break;
        ...
        case DAY_TO_MINUTE:
            ...
            break;
        case DAY_TO_SECOND:
            bound = DateTimeUtils.NANOS_PER_DAY;
            break;
        case HOUR_TO_MINUTE:
            bound = 60;
            break;
        case HOUR_TO_SECOND:
            bound = DateTimeUtils.NANOS_PER_HOUR;
            break;
        case MINUTE_TO_SECOND:
            bound = DateTimeUtils.NANOS_PER_MINUTE;
            break;
        default:
    ...
    public static long hoursFromInterval(IntervalQualifier qualifier, boolean negative, long leading, long remaining) {
        ...
        case DAY_TO_MINUTE:
            ...
            break;
        case DAY_TO_SECOND:
            v = remaining / DateTimeUtils.NANOS_PER_HOUR;
            break;
        default:
            return 0;
        }
    ...
    public static long minutesFromInterval(IntervalQualifier qualifier, boolean negative, long leading,
        ...
        case DAY_TO_MINUTE:
            ...
            break;
        case DAY_TO_SECOND:
            v = remaining / DateTimeUtils.NANOS_PER_MINUTE % 60;
            break;
        case HOUR_TO_MINUTE:
            v = remaining;
            break;
        case HOUR_TO_SECOND:
            v = remaining / DateTimeUtils.NANOS_PER_MINUTE;
            break;
        default:
            return 0;
        }
    ...
    public static long nanosFromInterval(IntervalQualifier qualifier, boolean negative, long leading, long remaining) {
        ...
        switch (qualifier) {
        case SECOND:
            v = leading * DateTimeUtils.NANOS_PER_SECOND + remaining;
            break;
        case DAY_TO_SECOND:
        case HOUR_TO_SECOND:
            v = remaining % DateTimeUtils.NANOS_PER_MINUTE;
