...
public class Constants {
    ...
    /**
     * If Guinsoo is compiled to be included in a product, this should be set to
    ...
    /**
     * The default port number of the HTTP server (for the Guinsoo Console).
    ...
    /**
     * The name of the server properties file for the Guinsoo Console.
     */
    public static final String SERVER_PROPERTIES_NAME = ".guinsoo.server.properties";
    ...
    /**
     * The file name suffix of a Guinsoo version 1.1 database file.
     */
     ...
     */
    public static final String USER_PACKAGE = "org.guinsoo.dynamic";
