...
<body style="margin: 20px">
    ...
    &nbsp;&nbsp; <a href="help.jsp?jsessionid=${sessionId}">${text.a.help}</a>
        ...
        <div id="url" style="display: none">
            ...
            <h3>Embedded</h3>
            <p>
            The URL <code>jdbc:guinsoo:~/test</code> means the database is stored in
            the user home directory in files starting with 'test'.
            Absolute locations like <code>jdbc:guinsoo:/data/db/test</code> are supported.
            ...
            URLs of the form <code>jdbc:guinsoo:./data/test</code> are relative to
            ...
            <p>
            The URL <code>jdbc:guinsoo:tcp://localhost/~/test</code> means connect
            ...
            <h4>In-Memory</h4>
            <p>
            The URL <code>jdbc:guinsoo:mem:test</code> means open an in-memory database
