...
import org.guinsoo.mvstore.FileStore;
...
import org.guinsoo.engine.QueryStatisticsData;
...
import org.guinsoo.index.MetaIndex;
...
public final class InformationSchemaTable extends MetaTable {
    ...
    private void sessions(SessionLocal session, ArrayList<Row> rows, SessionLocal s) {
        ...
        add(session, rows,
                ...
                // SLEEP_SINCE
                s.getState() == SessionLocal.State.SLEEP ? s.getCommandStartOrEnd() : null
        );
    }
