...
public class GUIConsole extends Console implements ActionListener, MouseListener, WindowListener {
    ...
    private boolean createTrayIcon() {
        try {
            ...
            MenuItem itemConsole = new MenuItem("Guinsoo Console");
            ...
            if (d.width >= 24 && d.height >= 24) {
                iconFile = "/org/guinsoo/res/guinsoo-24.png";
                ...
                iconFile = "/org/guinsoo/res/guinsoo-64-t.png";
                // iconFile = "/org/guinsoo/res/guinsoo-22-t.png";
            } else {
                iconFile = "/org/guinsoo/res/guinsoo.png";
            }
            Image icon = loadImage(iconFile);

            // trayIcon = new TrayIcon(image, "Guinsoo Database Engine",
            //         menuConsole);
            trayIcon = Utils.newInstance("java.awt.TrayIcon",
                    icon, "Guinsoo Database Engine", menuConsole);
    ...
    private void showStatusWindow() {
        ...
        statusFrame = new Frame("Guinsoo Console");
        statusFrame.addWindowListener(this);
        Image image = loadImage("/org/guinsoo/res/guinsoo.png");
        if (image != null) {
        ...
        Label label = new Label("Guinsoo Console URL:", Label.LEFT);
        label.setFont(font);
    ...
    private void showCreateDatabase() {
        ...
        createFrame = new Frame("Guinsoo Console");
