...
import org.guinsoo.store.fs.disk.FilePathDisk;
...
public abstract class FilePath {
    ...
    static {
        ...
        for (String c : new String[] {
                "org.guinsoo.store.fs.disk.FilePathDisk",
                "org.guinsoo.store.fs.mem.FilePathMem",
                "org.guinsoo.store.fs.mem.FilePathMemLZF",
                "org.guinsoo.store.fs.niomem.FilePathNioMem",
                "org.guinsoo.store.fs.niomem.FilePathNioMemLZF",
                "org.guinsoo.store.fs.split.FilePathSplit",
                "org.guinsoo.store.fs.niomapped.FilePathNioMapped",
                "org.guinsoo.store.fs.async.FilePathAsync",
                "org.guinsoo.store.fs.zip.FilePathZip",
                "org.guinsoo.store.fs.retry.FilePathRetryOnInterrupt"
        }) {
            try {
