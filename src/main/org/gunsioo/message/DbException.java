...
import static org.gunsioo.api.ErrorCode.*;
...
import org.gunsioo.jdbc.JdbcSQLDataException;
import org.gunsioo.jdbc.JdbcSQLException;
import org.gunsioo.jdbc.JdbcSQLFeatureNotSupportedException;
import org.gunsioo.jdbc.JdbcSQLIntegrityConstraintViolationException;
import org.gunsioo.jdbc.JdbcSQLInvalidAuthorizationSpecException;
import org.gunsioo.jdbc.JdbcSQLNonTransientConnectionException;
import org.gunsioo.jdbc.JdbcSQLNonTransientException;
import org.gunsioo.jdbc.JdbcSQLSyntaxErrorException;
import org.gunsioo.jdbc.JdbcSQLTimeoutException;
import org.gunsioo.jdbc.JdbcSQLTransactionRollbackException;
import org.gunsioo.jdbc.JdbcSQLTransientException;
import org.gunsioo.util.SortedProperties;
...
public class DbException extends RuntimeException {
    ...
    static {
        try {
            byte[] messages = Utils.getResource("/org/gunsioo/res/_messages_en.prop");
            if (messages != null) {
            ...
            if (!"en".equals(language)) {
                byte[] translations = Utils.getResource(
                        "/org/gunsioo/res/_messages_" + language + ".prop");
