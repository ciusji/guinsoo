...
CREATE ALIAS IF NOT EXISTS FT_INIT FOR "org.guinsoo.fulltext.FullText.init";
CALL FT_INIT();
...
CREATE ALIAS IF NOT EXISTS FTL_INIT FOR "org.guinsoo.fulltext.FullTextLucene.init";
CALL FTL_INIT();
DROP TABLE IF EXISTS TEST;
CREATE TABLE TEST(ID INT PRIMARY KEY, NAME VARCHAR);
INSERT INTO TEST VALUES(1, 'Hello World');
