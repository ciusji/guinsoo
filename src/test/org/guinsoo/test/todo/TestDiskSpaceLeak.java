...
public class TestDiskSpaceLeak {
    ...
    public static void main(String... args) throws Exception {
        ...
        long before = 0;
        for (int i = 0; i < 10; i++) {
            conn = DriverManager.getConnection("jdbc:guinsoo:data/test");
            ResultSet rs;
            ...
            new File("data/test.guinsoo.sql").renameTo(new File("data/test." + i + ".sql"));
            conn = DriverManager.getConnection("jdbc:guinsoo:data/test");
            ...
            long now = new File("data/test.guinsoo.db").length();
