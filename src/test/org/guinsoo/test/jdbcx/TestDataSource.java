 ...
 */
package org.guinsoo.test.jdbcx;
...
import org.guinsoo.jdbcx.JdbcDataSourceFactory;
import org.guinsoo.jdbcx.JdbcXAConnection;
...
//     }
    ...
    private void testDataSourceFactory() throws Exception {
        ...
        ref.add(new StringRefAddr("url", "jdbc:guinsoo:mem:"));
        ...
        assertEquals("jdbc:guinsoo:mem:", ds.getURL());
