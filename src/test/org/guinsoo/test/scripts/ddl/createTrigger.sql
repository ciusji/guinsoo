...
CREATE TRIGGER T1 BEFORE INSERT, UPDATE ON TEST FOR EACH ROW CALL 'org.guinsoo.test.scripts.Trigger1';
> ok
...
CREATE TRIGGER T1 BEFORE INSERT ON TEST FOR EACH ROW CALL 'org.guinsoo.test.scripts.Trigger1';
> ok
...
CREATE TRIGGER T1 BEFORE INSERT ON TEST FOR EACH STATEMENT CALL 'org.guinsoo.test.scripts.Trigger1';
> ok
...
'org.guinsoo.api.Trigger create() {
    return new org.guinsoo.api.Trigger() {
