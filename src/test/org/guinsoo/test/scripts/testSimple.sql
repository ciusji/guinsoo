...
create trigger TEST_TRIGGER before insert on test call "org.guinsoo.test.db.TestTriggersConstraints";
> ok
...
create linked table test_link('org.guinsoo.Driver', 'jdbc:guinsoo:mem:', 'sa', 'sa', 'DUAL');
> ok
