...
CREATE AGGREGATE B FOR 'org.guinsoo.test.scripts.Aggregate1';
> ok
...
> ID_A <> ID_B SQL_A                                                     SQL_B
> ------------ --------------------------------------------------------- ------------------------------------------------------------------------
> TRUE         CREATE FORCE ALIAS "PUBLIC"."A" FOR 'java.lang.Math.sqrt' CREATE FORCE AGGREGATE "PUBLIC"."B" FOR 'org.guinsoo.test.scripts.Aggregate1'
> rows: 1
...
CREATE TRIGGER G_A BEFORE INSERT ON T_A FOR EACH ROW CALL 'org.guinsoo.test.scripts.Trigger1';
> ok
...
CREATE TRIGGER G_B BEFORE INSERT ON T_B FOR EACH ROW CALL 'org.guinsoo.test.scripts.Trigger1';
> ok
...
> TRIGGER    TRUE         CREATE FORCE TRIGGER "PUBLIC"."G_A" BEFORE INSERT ON "PUBLIC"."T_A" FOR EACH ROW QUEUE 1024 CALL 'org.guinsoo.test.scripts.Trigger1' CREATE FORCE TRIGGER "PUBLIC"."G_B" BEFORE INSERT ON "PUBLIC"."T_B" FOR EACH ROW QUEUE 1024 CALL 'org.guinsoo.test.scripts.Trigger1'
> rows: 5
