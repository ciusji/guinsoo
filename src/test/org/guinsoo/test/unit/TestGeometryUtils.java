...
import static org.guinsoo.util.geometry.GeometryUtils.DIMENSION_SYSTEM_XY;
import static org.guinsoo.util.geometry.GeometryUtils.DIMENSION_SYSTEM_XYM;
import static org.guinsoo.util.geometry.GeometryUtils.DIMENSION_SYSTEM_XYZ;
import static org.guinsoo.util.geometry.GeometryUtils.DIMENSION_SYSTEM_XYZM;
import static org.guinsoo.util.geometry.GeometryUtils.GEOMETRY_COLLECTION;
import static org.guinsoo.util.geometry.GeometryUtils.M;
import static org.guinsoo.util.geometry.GeometryUtils.MAX_X;
import static org.guinsoo.util.geometry.GeometryUtils.MAX_Y;
import static org.guinsoo.util.geometry.GeometryUtils.MIN_X;
import static org.guinsoo.util.geometry.GeometryUtils.MIN_Y;
import static org.guinsoo.util.geometry.GeometryUtils.X;
import static org.guinsoo.util.geometry.GeometryUtils.Y;
import static org.guinsoo.util.geometry.GeometryUtils.Z;
...
import org.guinsoo.util.geometry.EWKBUtils;
import org.guinsoo.util.geometry.EWKBUtils.EWKBTarget;
import org.guinsoo.util.geometry.EWKTUtils;
import org.guinsoo.util.geometry.EWKTUtils.EWKTTarget;
import org.guinsoo.util.geometry.GeometryUtils;
import org.guinsoo.util.geometry.GeometryUtils.DimensionSystemTarget;
import org.guinsoo.util.geometry.GeometryUtils.EnvelopeAndDimensionSystemTarget;
import org.guinsoo.util.geometry.GeometryUtils.Target;
import org.guinsoo.util.geometry.JTSUtils;
import org.guinsoo.util.geometry.JTSUtils.GeometryTarget;
...
/**
 * Tests the classes from org.guinsoo.util.geometry package.
 */
public class TestGeometryUtils extends TestBase {
    ...
    private void testGeometry(String wkt, String guinsooWkt, String jtsWkt, int numOfDimensions, boolean withEWKB)
            throws Exception {
        ...
        assertEquals(guinsooWkt, EWKTUtils.ewkb2ewkt(wkbFromJTS));
        ...
        Geometry geometryFromGuinsoo = JTSUtils.ewkb2geometry(wkbFromJTS);
        String got = new WKTWriter(numOfDimensions).write(geometryFromGuinsoo);
