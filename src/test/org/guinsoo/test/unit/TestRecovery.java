...
public class TestRecovery extends TestDb {
    ...
    private void testRecoverTestMode() throws Exception {
        String recoverTestLog = getBaseDir() + "/recovery.guinsoo.db.log";
    ...
    private void testRecoverFulltext() throws Exception {
        ...
        Connection conn = getConnection("recovery");
        Statement stat = conn.createStatement();
        stat.execute("CREATE ALIAS IF NOT EXISTS FTL_INIT FOR 'org.guinsoo.fulltext.FullTextLucene.init'");
    ...
    private void testCorrupt() throws Exception {
        ...
        conn.close();
        FileChannel f = FileUtils.open(getBaseDir() + "/recovery.guinsoo.db", "rw");
        ...
        String script = IOUtils.readStringAndClose(
                ...
                FileUtils.newInputStream(getBaseDir() + "/recovery.guinsoo.sql")), -1);
    ...
    private void testCompressedAndUncompressed() throws SQLException {
        ...
        String name = "recovery.guinsoo.sql";
    ...
    private void testRunScript() throws Exception {
        ...
        deleteDb("recovery");
        deleteDb("recovery2");
        FileUtils.delete(getBaseDir() + "/recovery.guinsoo.sql");
    ...
    private void testRunScript2() throws Exception {
        ...
        stat2.execute("runscript from '" + getBaseDir() + "/recovery.guinsoo.sql'");
        stat2.execute("select * from test");
        conn2.close();
