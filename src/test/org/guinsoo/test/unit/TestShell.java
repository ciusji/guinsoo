...
import org.guinsoo.tools.Shell;
...
public class TestShell extends TestBase {
    ...
    public void test() throws Exception {
        ...
        shell.runTool("-url", "jdbc:guinsoo:mem:", "-driver", "org.guinsoo.Driver",
    ...
    private void test(final boolean commandLineArgs) throws IOException {
        ...
        Task task = new Task() {
            ...
            public void call() throws Exception {
                try {
                    ...
                    if (commandLineArgs) {
                        shell.runTool("-url", "jdbc:guinsoo:mem:",
                                "-user", "sa", "-password", "sa");
                    } else {
                        shell.runTool();
                    }
        ...
        read("");
        read("Welcome to Guinsoo Shell");
        read("Exit with");
        if (!commandLineArgs) {
            read("[Enter]");
            testOut.println("jdbc:guinsoo:mem:");
            read("URL");
            testOut.println("");
            read("Driver");
            testOut.println("sa");
