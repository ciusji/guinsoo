...
import org.guinsoo.bnf.context.DbContextRule;
import org.guinsoo.bnf.context.DbProcedure;
...
public class TestBnf extends TestDb {
    ...
    private void testModes(Connection conn) throws Exception {
        ...
        dbContents.readContents("jdbc:guinsoo:./test", conn);
        assertTrue(dbContents.isGuinsoo());
        dbContents = new DbContents();
