    ...
    private void testXML() {
        ...
        String s = StringUtils.xmlStartDoc()
                ...
                + StringUtils.xmlNode("rss",
                    ...
                    + StringUtils.xmlNode("channel", null,
                        StringUtils.xmlNode("title", null, "Guinsoo Database Engine")
                        + StringUtils.xmlNode("link", null, "https://guinsoodatabase.com")
                        + StringUtils.xmlNode("description", null, "Guinsoo Database Engine")
        ...
        assertEquals(
                ...
                "<?xml version=\"1.0\"?>\n"
                        ...
                        + "    -->\n"
                        + "    <channel>\n"
                        + "        <title>Guinsoo Database Engine</title>\n"
                        + "        <link>https://guinsoodatabase.com</link>\n"
                        + "        <description>Guinsoo Database Engine</description>\n"
