...
public class TestLob extends TestDb {
    ...
    private void testRemoveAfterDeleteAndClose() throws Exception {
        ...
        long size = FileUtils.size(getBaseDir() + "/lob.guinsoo.sql");
    ...
    private void testLobCompression(boolean compress) throws Exception {
        ...
        conn.close();
        if (!config.memory) {
            long length = new File(getBaseDir() + "/lob.guinsoo.db").length();
    ...
    private void testLobGrowth() throws SQLException {
        ...
        final File dbFile = new File(getBaseDir(), "lob.guinsoo.db");
