...
import org.gunsioo.store.fs.disk.FilePathDisk;
...
public abstract class FilePath {
    ...
    static {
        ...
        for (String c : new String[] {
                "org.gunsioo.store.fs.disk.FilePathDisk",
                "org.gunsioo.store.fs.mem.FilePathMem",
                "org.gunsioo.store.fs.mem.FilePathMemLZF",
                "org.gunsioo.store.fs.niomem.FilePathNioMem",
                "org.gunsioo.store.fs.niomem.FilePathNioMemLZF",
                "org.gunsioo.store.fs.split.FilePathSplit",
                "org.gunsioo.store.fs.niomapped.FilePathNioMapped",
                "org.gunsioo.store.fs.async.FilePathAsync",
                "org.gunsioo.store.fs.zip.FilePathZip",
                "org.gunsioo.store.fs.retry.FilePathRetryOnInterrupt"
        }) {
            try {
